...
export default function PaginaNuevoJugador() {
  ...
  const clubes = ['Barcelona SC', 'LDU Quito', 'Emelec', 'Independiente del Valle', 'El Nacional', 'Aucas', 'Deportivo Cuenca', 'Mushuc Runa'];
    ...
    setTimeout(() => {
      ...
      if (crearOtro) {
        setFormData({
          nombre: '',
          apellidos: '',
          club: formData.club, // Mantiene el club seleccionado
          posicion: 'Delantero',
          dorsal: '',
          fechaNacimiento: '',
          nacionalidad: 'Ecuatoriana',
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--texto-secundario)' }}>
            Ingresa los datos del jugador para afiliarlo a un club
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <select name="club" value={formData.club} onChange={handleChange} className="w-full px-4 py-2.5 rounded-lg text-sm outline-none transition-all" style={{ background: 'var(--fondo-principal)', border: '1px solid var(--borde-suave)', color: 'var(--texto-primario)' }}>
