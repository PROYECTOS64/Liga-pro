...
// ============================================
// DATOS DE EJEMPLO - Jugadores ecuatorianos
// ============================================
const jugadoresData = [
  { id: '1', nombre: 'Enner Valencia', club: 'Barcelona SC', posicion: 'Delantero', dorsal: 13, estado: 'ACTIVO', foto: null },
  { id: '2', nombre: 'Ángel Mena', club: 'LDU Quito', posicion: 'Mediocampista', dorsal: 10, estado: 'ACTIVO', foto: null },
  { id: '3', nombre: 'Gonzalo Plata', club: 'Emelec', posicion: 'Extremo', dorsal: 7, estado: 'ACTIVO', foto: null },
  { id: '4', nombre: 'Moisés Caicedo', club: 'Independiente del Valle', posicion: 'Mediocampista', dorsal: 8, estado: 'ACTIVO', foto: null },
  { id: '5', nombre: 'Pervis Estupiñán', club: 'LDU Quito', posicion: 'Defensa', dorsal: 3, estado: 'SUSPENDIDO', foto: null },
  { id: '6', nombre: 'Piero Hincapié', club: 'Barcelona SC', posicion: 'Defensa', dorsal: 4, estado: 'ACTIVO', foto: null },
  { id: '7', nombre: 'Carlos Gruezo', club: 'Deportivo Cuenca', posicion: 'Mediocampista', dorsal: 5, estado: 'ACTIVO', foto: null },
  { id: '8', nombre: 'Alexander Domínguez', club: 'LDU Quito', posicion: 'Portero', dorsal: 1, estado: 'ACTIVO', foto: null },
  { id: '9', nombre: 'Félix Torres', club: 'Emelec', posicion: 'Defensa', dorsal: 2, estado: 'PENDIENTE', foto: null },
  { id: '10', nombre: 'Jeremy Sarmiento', club: 'Barcelona SC', posicion: 'Extremo', dorsal: 11, estado: 'ACTIVO', foto: null },
  { id: '11', nombre: 'Michael Estrada', club: 'El Nacional', posicion: 'Delantero', dorsal: 9, estado: 'ACTIVO', foto: null },
  { id: '12', nombre: 'Robert Arboleda', club: 'Aucas', posicion: 'Defensa', dorsal: 6, estado: 'ACTIVO', foto: null },
  { id: '13', nombre: 'Jhegson Méndez', club: 'Mushuc Runa', posicion: 'Mediocampista', dorsal: 14, estado: 'SUSPENDIDO', foto: null },
  { id: '14', nombre: 'Alan Franco', club: 'Independiente del Valle', posicion: 'Defensa', dorsal: 15, estado: 'ACTIVO', foto: null },
  { id: '15', nombre: 'Hernán Galíndez', club: 'Deportivo Cuenca', posicion: 'Portero', dorsal: 22, estado: 'PENDIENTE', foto: null },
];

const clubes = ['Todos', 'Barcelona SC', 'LDU Quito', 'Emelec', 'Independiente del Valle', 'El Nacional', 'Aucas', 'Deportivo Cuenca', 'Mushuc Runa'];
...
export default function PaginaJugadores() {
  ...
  const [tecnicos, setTecnicos] = useState([
    { id: 1, nombre: 'Sebastián Beccacece', cargo: 'Director Técnico' },
    { id: 2, nombre: 'Pablo Sánchez', cargo: 'Asistente Técnico' }
  ]);
  const [medicos, setMedicos] = useState([
    { id: 1, nombre: 'Dr. Carlos Medina', cargo: 'Médico Principal' },
    { id: 2, nombre: 'Lic. María Fernanda Torres', cargo: 'Fisioterapeuta' }
  ]);

  const agregarTecnico = () => {
    const nombre = prompt('Ingrese el nombre del técnico:');
    if (!nombre) return;
    const cargo = prompt('Ingrese el cargo (ej. Director Técnico):') || 'Asistente';
    setTecnicos([...tecnicos, { id: Date.now(), nombre, cargo }]);
  };
  ...
  const agregarMedico = () => {
    ...
    if (!nombre) return;
    const cargo = prompt('Ingrese el cargo (ej. Médico Principal):') || 'Asistente Médico';
    setMedicos([...medicos, { id: Date.now(), nombre, cargo }]);
  };
